// TODO: GETTING ALL REQUIRED ELEMENT
...
const timerLine = quiz_box.querySelector("header .timer-line");
const timerOff = quiz_box.querySelector("header .time-text");

const option_list = document.querySelector(".option-list");

// const option_list = document.querySelector(".option-list");

// TODO: IF START QUIZ BUTTON CLICKED

start_btn.onclick = () => {
  info_box.classList.add("activeInfo");
};

// TODO: IF EXIT BUTTON CLICKED
exit_btn.onclick = () => {
  info_box.classList.remove("activeInfo");
};

// TODO: IF CONTINUE BUTTON CLICKED
...
// TODO:GETTING QUESTION AND OPTIONS FROM ARRAY
...
function optionSelected(answer) {
  ...
  if (userAns == correcAns) {
    ...
    // TODO: if answer is incorrect then automtically select right answer
  ...
  //TODO:once user selected disable
